...
public class FunctionLibrary {
	...
	public static void capturesup(String LocatorType,String LocatorValue) throws Throwable
	{
		...
		FileWriter fw =new FileWriter("./CaptureData/abc.txt");
		BufferedWriter bw = new BufferedWriter(fw);
	...
	public static void supplierTable() throws Throwable
	{
		...
		FileReader fr = new FileReader("./CaptureData/abc.txt");
		BufferedReader br = new BufferedReader(fr);
		String Exp_Data = br.readLine();
		if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
		...
		driver.findElement(By.xpath(conpro.getProperty("search-button"))).click();
		Thread.sleep(3000);
		String Act_Data = driver.findElement(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td[6]/span/span")).getText();
		Reporter.log(Act_Data+"============"+Exp_Data,true);
		try {
	...
	public static void customerTable() throws Throwable
	{
		...
		Reporter.log(Act_Data+"============"+Exp_Data,true);
		try {
			Assert.assertEquals(Act_Data, Exp_Data,"custoer Number is Not Matching");
		}catch(AssertionError a)
		{
			System.out.println(a.getMessage());
		}
